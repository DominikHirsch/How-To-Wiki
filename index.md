...
layout: single
permalink: /
aliases: ["Reformpädagogik Einleitung", "Pädagogische Reformbewegung"]
---
...
<details>
  <summary><strong>Mehr Details</strong></summary>
  <ul>
...
```mermaid
	 graph LR
	    A[Ganzheitlichkeit] --> B[Kognitiv: Wissen & Denken]
	    A --> C[Emotional: Empathie & Selbstwirksamkeit]
	    A --> D[Praktisch: Handeln & Gestalten]
	    A --> E[Sozial: Gemeinschaft & Demokratie]
	
	    B -->|Beispiel| F[Montessori-Materialien]
	    C -->|Beispiel| G[Klassenrat]
	    D -->|Beispiel| H[Schulgarten]
